...
public:
	...
	// IDR Fields
	MOCK_CONST_METHOD0(get_IDR_IDR0, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR1, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR2, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR3, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR4, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR5, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR6, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR7, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR8, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR9, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR10, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR11, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR12, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR13, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR14, uint32_t());
	MOCK_CONST_METHOD0(get_IDR_IDR15, uint32_t());

	// ODR Fields
	MOCK_CONST_METHOD0(get_ODR_ODR0, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR1, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR2, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR3, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR4, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR5, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR6, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR7, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR8, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR9, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR10, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR11, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR12, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR13, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR14, uint32_t());
	MOCK_CONST_METHOD0(get_ODR_ODR15, uint32_t());
	MOCK_METHOD1(set_ODR_ODR0, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR1, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR2, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR3, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR4, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR5, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR6, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR7, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR8, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR9, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR10, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR11, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR12, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR13, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR14, void(uint32_t value));
	MOCK_METHOD1(set_ODR_ODR15, void(uint32_t value));

	// BSRR Fields
	MOCK_METHOD1(set_BSRR_BS0, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS1, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS2, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS3, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS4, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS5, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS6, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS7, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS8, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS9, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS10, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS11, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS12, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS13, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS14, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BS15, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR0, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR1, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR2, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR3, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR4, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR5, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR6, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR7, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR8, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR9, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR10, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR11, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR12, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR13, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR14, void(uint32_t value));
	MOCK_METHOD1(set_BSRR_BR15, void(uint32_t value));
